...
A circuit board will perform most of the communications interfaces tasks in the CanSat. Communications interfaces will carry high level of intelligence and pre-defined protocols to achieve the hardware and software parallelism, to provide a secured platform for the CanSat to ensure its functionalities. 
