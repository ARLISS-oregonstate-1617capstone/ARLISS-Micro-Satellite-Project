...
\subsection{\textbf{Updated Gantt Chart}}
...
\begin{landscape}
	...
	\begin{ganttchart}[vgrid={draw=none,draw=none},%
		...
		\ganttbar{Obstacle Avoidance System}{11}{19} \\
		\ganttbar{Computer Vision Systems}{11}{19} \\
		\ganttbar{Navigation System}{13}{21} \\                
                \ganttbar{Parachute Deployment}{14}{18} \ganttnewline
		\ganttbar{Change to Drive Mode}{17}{25} \ganttnewline
		\ganttbar{Progress report}{18}{20} \ganttnewline
		%%%%%%%%%%%%%%%%%Spring2017
		\ganttgroup{Spring 2017}{21}{30} \\
                \ganttbar{BugFixing and Improvements}{21}{27} \ganttnewline
                \ganttbar{Sensor and Motor Initialization}{23}{27} \ganttnewline
                \ganttbar{Engineering Expo!}{27}{27} \ganttnewline
		\ganttbar{Final Report}{28}{30} \ganttnewline
